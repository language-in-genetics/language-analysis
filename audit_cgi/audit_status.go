...
<body>
    <div class="container">
        <div class="card">
            ...
            <p class="small">This page is public. The editing interface lives at <a href="/cgi-bin/audit.cgi{{queryWithBatch .Batch.SampleBatch}}">/cgi-bin/audit.cgi</a> and requires login.</p>
